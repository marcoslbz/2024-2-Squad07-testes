...
function inicializaMapa() {
    map = L.map('map').setView([-15.802825, -47.798767], 10.4);
...
// Exporta a função formatarBRL para uso nos testes
if (typeof module !== 'undefined' && module.exports) {
    module.exports = { formatarBRL };
}
